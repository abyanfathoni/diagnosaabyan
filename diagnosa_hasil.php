    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-white">Hasil diagnosa Penyakit Buta Warna dengan metode forward chaining.</p>
                <div class="form">
                    <div class="container">
                                                ...
                                                <table class="table table-bordered text-left">
                                                    ...
                                                    if($hasil != "0"){
                                                        ...
                                                        while($k=mysqli_fetch_array($alternatif)){
                                                            ?>
                                                            <tr>
                                                                <th width="30%">Nama Penyakit <br/></th>
                                                                <td><b><?php echo $k['alt_inisial']; ?> - <?php echo $k['alt_nama']; ?></b></td>
                                                            </tr>                    
                                                            <tr>
                                                                <th width="30%">PENGERTIAN</th>
                                                                <td><?php echo $k['alt_penyebab']; ?></td>
                                                            </tr>    
                                                            <tr>
                                                                <th width="30%">SOLUSI DAN OBAT</th>
                                                        ...
                                                        <tr>
                                                            <th width="30%">Nama Penyakit <br/></th>
                                                            <td><b><i>Gejala Penyakit Buta Warna Tidak Ditemukan. Lakukan Pengecekan ulang ^_^.</i></b></td>
                                                        </tr>                     
                                                        <tr>
                                                            <th width="30%">PENGERTIAN</th>
                                                            <td>-</td>
